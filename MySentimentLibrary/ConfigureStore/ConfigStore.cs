...
namespace VaderSharp
{
    ...
    public class ConfigStore
    {
        ...
        {
            //C: \Users\Sofia\Desktop\vadersharp - master\VaderSharp\VaderSharp\ConfigStore\strings\en - gb.xml
            string path = $"C:/Users/Sofia/Desktop/vadersharp-master/VaderSharp/VaderSharp/strings/{languageCode}.xml";
            if (!File.Exists(path))
            {
